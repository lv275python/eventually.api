...
from utils.validators import required_keys_validator, string_validator
...
class SuggestedTopicsView(View):
    ...
    def get(self, request):
        ...
        :return: the response with the certain suggested topic information. If suggested_topic_id does
    ...
    def post(self, request):
        ...
        if suggested_topic and required_keys_validator(data, keys_required, False):
